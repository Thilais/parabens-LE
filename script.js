const questions = [
    ...
    { question: "Lê, feliz aniversário \o/ ! Desejo que a vida traga muitas realizações em seu novo ciclo! Sorte a nossa em ter uma pessoa tão incrível como você é! Aproveite muito o seu dia ao lado das pessoas que te fazem bem!", answers: ["Dri", "Karina", "Jean"], correct: 1 },
];
...
function showResults() {
    ...
    // Como são sempre 9 perguntas, não há necessidade de atualizar o número total de perguntas
}
